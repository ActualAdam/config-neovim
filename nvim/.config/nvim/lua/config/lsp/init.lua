...
lsp.on_attach = function(_, bufnr)
  ...
  -- nmap('<C-k>', vim.lsp.buf.signature_help, 'Signature Documentation') -- todo: find another mapping for this. in fact maybe something consistent for all the lsp stuff.
